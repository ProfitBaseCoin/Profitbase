...
#   c) node1 mines 32 blocks, so now node 0 has 60001pbc, node 1 has 4250pbc, node2 has none.
#   d) node0 sends 601 pbc to node2, in two transactions (301 pbc, then 300 pbc).
