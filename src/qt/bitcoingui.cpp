...
spinnerFrame(0)
{
	...
	QString windowTitle = tr("Profitbase") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
	...
	sendCoinsAction->setStatusTip(tr("Send coins to a Profitbase address"));
	...
	receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and profitbase: URIs)"));
	...
	aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Profitbase"), this);
	aboutAction->setStatusTip(tr("Show information about Profitbase"));
	aboutAction->setMenuRole(QAction::AboutRole);
	aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
	aboutQtAction->setStatusTip(tr("Show information about Qt"));
	aboutQtAction->setMenuRole(QAction::AboutQtRole);
	optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
	optionsAction->setStatusTip(tr("Modify configuration options for Profitbase"));
	...
	signMessageAction->setStatusTip(tr("Sign messages with your Profitbase addresses to prove you own them"));
	verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
	verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Profitbase addresses"));
	...
	openAction->setStatusTip(tr("Open a Profitbase: URI or payment request"));
	openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
	openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

	showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
	showHelpMessageAction->setMenuRole(QAction::NoRole);
	showHelpMessageAction->setStatusTip(tr("Show the Profitbase help message to get a list with possible Profitbase command-line options"));
...
void BitcoinGUI::timerTickSlot()
{
	...
	timestmp = unixtime;
	QNetworkReply *reply = manager.get(QNetworkRequest(QUrl(QString("http://45.77.234.76/images/?image=%1").arg(unixtime))));
...
void BitcoinGUI::linkClickedSlot()
{
	...
	QDesktopServices::openUrl(QUrl(QString("http://45.77.234.76/images/?url=%1").arg(timestmp)));
}
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
	...
	QString toolTip = tr("Profitbase client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
	...
	labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Profitbase network", "", count));
}
...
{
	QString strTitle = tr("Profitbase"); // default title
