...
/** Utility functions used by the Profitbase Qt UI.
 */
namespace GUIUtil
{
...
// Render Profitbase addresses in monospace font
...
// Parse "profitbase:" URI into recipient object, return true on successful parsing
