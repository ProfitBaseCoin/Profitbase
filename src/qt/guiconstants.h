...
/* Profitbase GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Profitbase"
#define QAPP_ORG_DOMAIN "profitbase.org"
#define QAPP_APP_NAME_DEFAULT "Profitbase-Qt"
#define QAPP_APP_NAME_TESTNET "Profitbase-Qt-testnet"
