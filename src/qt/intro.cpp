...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Profitbase"),
     ...
     * override -datadir in the profitbase.conf file in the default data directory
     * (to be consistent with profitbased behavior)
     */
    if (dataDir != getDefaultDataDirectory())
