...
/** 
    ...
    ****Note - for Profitbase we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of profitbase coming in to a transaction
