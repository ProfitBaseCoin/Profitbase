...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Profitbase profitbase-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  profitbase-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded profitbase transaction") + "\n" +
                               "  profitbase-tx [options] -create [commands]   " + _("Create hex-encoded profitbase transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded profitbase transaction
