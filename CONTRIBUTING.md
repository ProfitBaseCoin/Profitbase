Contributing to Profitbase
============================

The Profitbase project operates an open contributor model where anyone is
...
The following applies to code changes to the Profitbase project, and is not to be
confused with overall Profitbase Network Protocol consensus changes.

Whether a pull request is merged into Profitbase rests with the project merge
...
Patches that change Profitbase consensus rules are considerably more involved than
...
Where a patch set proposes to change the Profitbase consensus, it must have been
...
The project leader is the release manager for each Profitbase release.
