...
In order to support loading of multiple wallets in profitbase-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is profitbase.cpp.
...
Changes to profitbase.cpp
----------------------
profitbase.cpp is the entry point into profitbase-qt, and as such, will require some minor modifications to provide hooks for
