...
This mechanism has been integrated into Bitcore-Node-Profitbase which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Profitbase-Project/insight-api-profitbase#web-socket-api](https://github.com/Profitbase-Project/insight-api-profitbase#web-socket-api) 
* API: [https://github.com/Profitbase-Project/insight-api-profitbase#swifttx-transactions](https://github.com/Profitbase-Project/insight-api-profitbase#swifttx-transactions) 
...
By default, the Profitbase daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Profitbase daemon:
